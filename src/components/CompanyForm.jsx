                    ...
                    <form id="company-form" onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input required type="text" className="w-full border-slate-300 rounded-lg shadow-sm focus:border-primary-500 focus:ring-primary-500 bg-white"
                            ...
                            <div>
                                ...
                                <input required type="email" className="w-full border-slate-300 rounded-lg shadow-sm focus:border-primary-500 focus:ring-primary-500"
                                    value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })} />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1">Subscription Plan</label>
                                <select className="w-full border-slate-300 rounded-lg shadow-sm focus:border-primary-500 focus:ring-primary-500"
                            ...
                            <div>
                                ...
                                <input type="text" className="w-full border-slate-300 rounded-lg shadow-sm focus:border-primary-500 focus:ring-primary-500"
                                ...
                                <div className="col-span-full border-t border-slate-100 pt-6 mt-2">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-in slide-in-from-top-2 duration-200">
                                        <div>
                                            ...
                                            <input required type="text" className="w-full border-slate-300 rounded-lg shadow-sm focus:ring-primary-500 focus:ring-1 focus:border-primary-500 bg-white p-2"
                                        ...
                                        <div>
                                            ...
                                            <input required type="email" className="w-full border-slate-300 rounded-lg shadow-sm focus:ring-primary-500 focus:ring-1 focus:border-primary-500 bg-white p-2"
                                        ...
                                        <div>
                                            ...
                                            <input required type="password" title="At least 6 characters" className="w-full border-slate-300 rounded-lg shadow-sm focus:ring-primary-500 focus:ring-1 focus:border-primary-500 bg-white p-2"
